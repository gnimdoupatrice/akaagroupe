...
import heroImage from "@/assets/Photo de lea abalo.jpg";

const navItems = [
  { label: "Packaging", href: "/Packaging" },
  { label: "Communication", href: "/Communication" },
  { label: "Store/Projects", href: "/StoreProjects" },
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          >
            <Link to="/" className="flex items-center">
              <span className="h-8 md:h-12 w-auto">
                <img src={heroImage} alt="AK-GROUP" className="h-10 w-auto" />
              </span>
            </Link>
          </motion.div>
